    ...
    <head>
        ...
        <style>
            ...
            .hero {
                ...
                background: linear-gradient(135deg, #abc6ff 0%, var(--secondary) 100%);
                color: white;
                border-radius: 10px;
            }
                ...
                @if (Route::has('login'))
                    <nav class="-mx-3 flex flex-1 justify-end">
                        @auth
                            ...
                            > Dashboard </a>
                        @else
                            <a href="{{ route('login') }}" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white" style="width: max-content;"> {{ __('Login') }}                            </a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white" style="width: max-content;"> {{ __('Register') }}
                                </a>
                            @endif
                        @endauth
                    </nav>
        ...
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50" style="background-color: rgba(255, 255, 255, 0.5);">
            <div class="relative flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full px-6">
                    ...
                    {{-- <section class="" id="services" style="padding-top: 30px; padding-bottom: 30px;margin: auto; width: 90%;">
                        ...
                        <div class="features-grid">
                            ...
                            <div class="feature-card">
                                ...
                                <div class="section-title">
                                    <h3>Control de instituciones de Salud</h3>
                                </div>
                    ...
                    <div class="container">
    <h2>Contacto</h2>
    <p class="description">Completá el siguiente formulario para comunicarte con nosotros.</p>
